...
<x-store-layout>
	...
	<div class="owl-carousel owl-single home-slider">
		...
		<div class="item">
			<div class="untree_co-hero" style="background-image: url({{asset('assets/store/images/hero-slider-2-min.jpg')}});">
				<div class="container">
					<div class="row align-items-center">
						<div class="col-lg-6">
	...
	<div class="untree_co-section">
		<div class="container">
			...
			<div class="deal-hero overlay" style="background-image: url({{asset('assets/store/images/hero-slider-4-min.jpg')}})">
				...
				{{-- <div class="col-6 col-sm-6 col-md-6 mb-4 col-lg-4">
					<div class="product-item">
						<a href="shop-single.html" class="product-img">
							...
							<img src="{{asset('assets/store/images/hero-slider-1-min.jpg')}}" alt="Image" class="img-fluid">
						</a>
