{{-- @php
    $dir = App::getLocale($lang) == 'ar' ? 'rtl' : 'ltr';
@endphp --}}
<!DOCTYPE html>
<!--
...
<body class="hold-transition sidebar-mini" dir="{{ LaravelLocalization::getCurrentLocaleDirection() }}">
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        ...
        {{-- <a href="index3.html" class="nav-link">{{ LaravelLocalization::getCurrentLocale() }}</a> --}}
      </li>
